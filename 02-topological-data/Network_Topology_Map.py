# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 10:07:12 2024

@author: ariccardi
"""

# %%% Clear workspace and options
...
export_map = True
export_data = True
points_file_name = "Data/Centroids.csv"
adj_matrix_file_name = "Data/Adj.csv"
adj_wei_matrix_file_name = "Data/Adj_W.csv"
...
if plot_map == True:
    ...
    if export_map == True:
        ...
        map_file_name = "Data/EEA-ENB_Topology_Map.png"
        fig.savefig(map_file_name, transparent=True, bbox_inches='tight', dpi='figure')
        map_file_name = "Data/EEA-ENB_Topology_Map.pdf"
        fig.savefig(map_file_name, transparent=True, bbox_inches='tight', dpi='figure')
